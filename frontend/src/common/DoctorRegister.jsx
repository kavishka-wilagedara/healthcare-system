...
const DoctorRegister = () => {
  ...
  const validate = () => {
    ...
    if (!formData.contact || !/^\+94\d{9}$/.test(formData.contact)) newErrors.contact = 'Valid contact number is required';
  ...
  return (
    <div className="container py-5">
      <h3 className="display-5 fw-bold text-teal mb-5 text-center">Doctor Registration</h3>
          ...
          <div className="card shadow-sm healthcare-card">
            ...
            <div className="card-body">
              {[
                ...
                { label: 'Contact Number', name: 'contact', placeholder: '+94XXXXXXXXX' },
              ...
              <button className="btn btn-teal healthcare-btn mt-2" onClick={handleSubmit}>
                Register
              </button>
            </div>
          </div>
